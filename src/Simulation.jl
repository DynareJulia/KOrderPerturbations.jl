...
struct sim7
    ...
    new(y1, y2, gy, gu, gσσ, gyy, gyu, guu, nstate, nshock, state_index)
    end
end

SimulateWs = sim7

function simulate_run(GD, t_final, solverWs)
    ...
    simulate(GD, y0, ut, t_final, simWs)[:, end]
end
